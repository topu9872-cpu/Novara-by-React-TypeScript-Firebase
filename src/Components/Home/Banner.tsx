...
import { trackUniqueView } from "../../services/AdminDashboard";
        ...
        <div className="grid lg:grid-cols-2 items-center">
          ...
          <div className="relative z-20 px-8 py-12 lg:px-16 lg:py-16">
            ...
            <div className="anim-buttons mt-8 flex flex-wrap gap-4 opacity-0">
              <NavLink
                to={"/shop"}
                className="group bg-slate-900 hover:bg-black text-white px-6 py-3.5 rounded-xl flex items-center gap-2 shadow-lg shadow-slate-900/10 transition-all duration-300 hover:scale-105 active:scale-95"
              >
                <span>Shop Now</span>
              ...
              <NavLink
                to={"/Collections"}
                className="text-gray-700 font-medium hover:text-black transition-colors px-4 py-3.5"
              >
                Explore Collections
              </NavLink>
            </div>
